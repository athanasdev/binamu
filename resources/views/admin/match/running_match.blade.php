                ...
                <tr>
	                ...
	                <td>
                  	...
                  	<td>
                        ...
                        <a href="{{ route('complete_match', $item->id) }}" title="Edit" style="float: left;margin-right: 10px;">

                            <button type="button" class="btn btn-primary btn-sm"><i class="fa fa-arrow-right"></i>
