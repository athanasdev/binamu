            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit slider Form</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
	          ...
	          <!-- left column -->
	          	...
	          	<div class="col-md-12">
		            ...
		            <!-- Horizontal Form -->
		              ...
		              <form class="form-horizontal" action="{{URL::to('admin/slider/'.$data->id)}}" method="post" enctype="multipart/form-data">
