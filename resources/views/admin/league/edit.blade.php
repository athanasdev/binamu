...
@section('title')
<title>Edit league | {{ config('app.name') }}  </title>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit league Form</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
	          ...
	          <!-- left column -->
	          	...
	          	<div class="col-md-12">
		            ...
		            <!-- Horizontal Form -->
		              ...
		              <form class="form-horizontal" action="{{URL::to('admin/league/'.$data->id)}}" method="post" enctype="multipart/form-data">
