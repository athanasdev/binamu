...
<section class="registration-area">
          ...
          <div class="registration-wrapper withdraw-wrapper">
              <div class="main-form-wrapper">
                  ...
                  <ul>
                      ...
                      <li>
                          <strong>Virtual currency network: </strong>
                          <p>{{ $user->digital_payment_method->name ?? '' }}</p>
                      </li>
                      <li>
                          <strong>Payment account: </strong>
                          <p>{{ $user->address_to_receive ?? '' }}</p>
                          <input type="hidden" value="{{ $user->digital_payment_method_id }}" name="payment_method_id">
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Rate: </strong>
                        <p> Rate: <span class="rate">0</span>% . You will get: <span class="real_money">0</span> USDT</p>
                    </li>
                      <li>
  ...
  <script>
    ...
    function updateRealMoneyAndPoundage(val){
        ...
        var payment_method_id = {{ $user->digital_payment_method_id }};
