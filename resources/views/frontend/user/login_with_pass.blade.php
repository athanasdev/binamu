    ...
    <main>
        <section class="section-padding">
            <div class="max-w-[600px] mx-auto px-4">
                ...
                <form action="{{ route('submit_login') }}" method="post" enctype="multipart/form-data" class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    @csrf
                    
                    <div class="sm:col-span-2 theme-input-container responsive-table">
                        <label class="text-sm font-semibold mb-1">মােবাইল নম্বর</label>
                        <input type="text" name="contact_number" class="input-border border border-gray-400 rounded-md w-full py-2 px-3">
                    </div>
