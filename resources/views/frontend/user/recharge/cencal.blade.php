...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/frontend/')}}/css/onepay_cancel.css">
</head>
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <p class="time_over">আদেশ বাতিল হয়েছে৷</p>
                <div>
                    <a href="javascript:void(0)" class="order_cancel">অর্ডার বন্ধ করুন</a>
                </div>
            </div>
        </div>
    </div>
...
<input type="hidden" name="" id="timer" data-hours="00" data-minutes="00" data-seconds="02">
<script>
    ...
    finished = ()=>{
        ...
        if (timerEnd == '' || timerEnd == null) {
            ...
            window.location.href = 'http://localhost/my_project/sport_invest/';
