...
@section('title')
<title> One Pay Recharge | {{ config('app.name') }}  </title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="recharge-amount-wrapper">
                    ...
                    <form action="{{ route('onepay') }}" method="get">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="payment-type">
                                        <input type="radio" id="foronepay" name="payment_method_id" value="onepay" checked>
                                        <label for="foronepay" style=" color: #1bb394"><img src="{{asset('assets/frontend/')}}/images/pay_logo.png" alt="" style=" height: 32px;"> OnePay </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="payment-type">
                                        <input type="radio" id="for{{$item->name}}" name="payment_method_id" value="{{$item->id}}" required>
                        ...
                        <button class="recharge-btn" type="submit">Payment</button>
                    </form>
                </div>
            </div>
        </div>
